...
export function LoginForm() {
	...
	return (
		<Card className="w-full max-w-[400px] border border-border/50 bg-card/60 backdrop-blur-xl shadow-2xl rounded-2xl p-5 sm:p-6 relative overflow-hidden transition-all duration-300 hover:shadow-primary/5 hover:border-primary/20">
			{/* Brand Header */}
			<div className="flex flex-col items-center gap-1.5 sm:gap-2 mb-4 sm:mb-6 mt-1 sm:mt-2">
				...
				<h1 className="text-lg sm:text-xl font-bold tracking-tight text-foreground text-center mt-2 sm:mt-3">
					Welcome to Nexora
				</h1>
					...
					<FieldGroup className="gap-4 sm:gap-5">
						...
						<Field>
							<div className="flex items-center justify-between mb-1.5">
								<FieldLabel
									htmlFor="password"
									className="text-[10px] font-bold text-foreground/80 tracking-wider uppercase"
								>
									Password
								</FieldLabel>
								<a
									href="/forgot-password"
									className="text-[11px] font-semibold text-primary hover:text-primary/80 hover:underline underline-offset-4 transition-colors"
								>
									Forgot password?
								</a>
							</div>
