...
import { B as onlineManager, C as useQueryClient, w as require_jsx_runtime } from "./modern-YuFVg-AM.js";
import { G as setupStyleSheet, I as mergeProps, P as lazy, V as render, m as createComponent, x as createSignal } from "./Q7GRFEEB-C720US2E.js";
//#region node_modules/.pnpm/@tanstack+query-devtools@5.100.14/node_modules/@tanstack/query-devtools/build/dev.js
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (this.#Component) Devtools = this.#Component;
				...
				Devtools = lazy(() => import("./VKXKX7EQ-DR585YKJ.js"));
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (this.#Component) Devtools = this.#Component;
				...
				Devtools = lazy(() => import("./ZUJJ2RGI-8GmvyB0_.js"));
				this.#Component = Devtools;
			}
			setupStyleSheet(this.#styleNonce, this.#shadowDOMTarget);
			return createComponent(Devtools, mergeProps({
...
//#endregion
//#region node_modules/.pnpm/@tanstack+react-query-devto_702a23150e7e3cf8fcfefdc08af081b9/node_modules/@tanstack/react-query-devtools/build/modern/ReactQueryDevtools.js
...
//#endregion
//#region node_modules/.pnpm/@tanstack+react-query-devto_702a23150e7e3cf8fcfefdc08af081b9/node_modules/@tanstack/react-query-devtools/build/modern/ReactQueryDevtoolsPanel.js
...
//#endregion
//#region node_modules/.pnpm/@tanstack+react-query-devto_702a23150e7e3cf8fcfefdc08af081b9/node_modules/@tanstack/react-query-devtools/build/modern/index.js
